...
async function fetchFacts(numberOfFacts){
  ...
  try{
    ...
    resultsContainer.textContent = "Error fetching cat facts. Please try again later.";
    return;
  }finally{
...
async function fetchCatPhotos(numberofPhotos){
  ...
  try{
    ...
    resultsContainer.textContent = "Error fetching cat photos. Please try again later.";
    return;
  } finally {
    spinner.style.display = "none"
  }
